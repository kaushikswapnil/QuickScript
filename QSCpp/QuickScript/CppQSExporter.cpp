...
std::filesystem::path GetExportedHeaderFilePathForType(const TypeDefinition& type, const std::filesystem::path& read_directory, const std::filesystem::path& output_directory)
{
...
void CppQSExporter::ExportTypeMap(const TypeMap& type_map, const std::filesystem::path& read_directory, const std::filesystem::path& output_directory)
{
	for (const auto& entry : type_map.m_Definitions)
	{
		...
		{
			const std::filesystem::path cpp_file_path = GetExportedHeaderFilePathForType(entry, read_directory, output_directory);
